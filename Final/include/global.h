...
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
                                                    Forrest Yu, 2005
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/
#ifndef GLOBAL_H  // 如果 GLOBAL_H 宏未定义，则执行下面的代码
#define GLOBAL_H  // 定义 GLOBAL_H 宏，避免重复包含
...
#include "memman.h"
#define MIN_PAGE_COUNT 12
#define SHELL_NAME "orange/shell_0.bin"
extern struct DoubleList Global_Page;
