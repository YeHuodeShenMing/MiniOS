...
#define	SA_RPL_MASK	0xFFFC		//第0/1位是0
#define	SA_RPL0		0
#define	SA_RPL1		1
#define	SA_RPL2		2
#define	SA_RPL3		3

#define	SA_TI_MASK	0xFFFB		//第2位是0
#define	SA_TIG		0
#define	SA_TIL		4
...
/* 初始化描述符函数 */
static void
init_segment(DESCRIPTOR *p_desc, u32 base, u32 limit, u16 attribute)//实际用到：32,20,12位
{
...
init_gate(GATE *p_gate, u8 desc_type, void *handler, u8 privilage)
{
	...
	p_gate->selector	= SELECTOR_FLAT_C;		//内核代码段选择子,相当于1号描述符
